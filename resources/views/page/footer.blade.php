    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-6 col-md-4 col-xs-12 col-lg-3">
          <div class="footer-logo"><a href="index.html"><img src="public/template/images/footer-logo.png" alt="fotter logo"></a> </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6 col-xs-12">
            <div class="payment">
              <ul>
                <li><a href="#"><img title="Visa" alt="Visa" src="public/template/images/visa.png"></a></li>
                <li><a href="#"><img title="Paypal" alt="Paypal" src="public/template/images/paypal.png"></a></li>
                <li><a href="#"><img title="Discover" alt="Discover" src="public/template/images/discover.png"></a></li>
                <li><a href="#"><img title="Master Card" alt="Master Card" src="public/template/images/master-card.png"></a></li>
              </ul>
            </div>
          </div>
        </div>
